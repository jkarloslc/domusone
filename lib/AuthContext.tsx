...
const ADMIN_MODULOS = [
  ...
  'proyectos', 'construcciones', 'mantenimiento', 'comunicados',
...
const LEER: Record<Rol, string[] | '*'> = {
  ...
  atencion_residentes: ['lotes', 'propietarios', 'contratos', 'escrituras',
                        'incidencias', 'proyectos', 'construcciones', 'mantenimiento', 'comunicados', 'reportes'],
  ...
  fraccionamiento:     ['lotes', 'propietarios', 'contratos', 'escrituras',
                        'proyectos', 'construcciones', 'mantenimiento', 'accesos', 'incidencias',
...
const ESCRIBIR: Record<Rol, string[] | '*'> = {
  ...
  usuariomantto:       USUARIOMANTTO_MODULOS,
  atencion_residentes: ['lotes', 'propietarios', 'contratos', 'escrituras',
                        'incidencias', 'proyectos', 'construcciones', 'mantenimiento', 'comunicados'],
