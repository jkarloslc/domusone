...
COMMENT ON COLUMN ctrl_acceso_acomp.id_familiar_fk IS 'ID del familiar del socio (si aplica)';
...
COMMENT ON COLUMN ctrl_acceso_acomp.id_pase_mov_fk IS 'ID del movimiento de pase consumido';
