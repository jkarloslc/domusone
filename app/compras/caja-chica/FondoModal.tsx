...
export default function FondoModal({ fondo, onClose, onSaved }: Props) {
  ...
  return (
    <ModalShell modulo="compras" titulo={isNew ? 'Asignar Fondo de Caja Chica' : 'Editar Fondo'} onClose={onClose} maxWidth={480}
      footer={<>        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, padding: '14px 24px', borderTop: '1px solid var(--border)' }}>
