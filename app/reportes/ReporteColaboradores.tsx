...
export default function ReporteColaboradores() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true)
    const [{ data: colabs }, { data: cuads }, { data: ccs }] = await Promise.all([
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', gap: 10, marginBottom: 16, flexWrap: 'wrap' }}>
        ...
        <select className="select" style={{ flex: '1 1 120px', maxWidth: 170 }} value={filtroCC} onChange={e => setFCC(e.target.value)}>
