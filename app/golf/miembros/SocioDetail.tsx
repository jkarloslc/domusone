    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
            <div style={{
              ...
              background: '#b8952a', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
            }}>
              <User size={22} style={{ color: '#fff' }} />
            </div>
            <div>
              <div style={{ fontFamily: 'inherit', fontSize: 18, fontWeight: 600, color: '#1e293b' }}>{nombre}</div>
              {socio.numero_socio && (
                <div style={{ fontSize: 12, color: '#94a3b8', marginTop: 2 }}>Socio #{socio.numero_socio}</div>
              )}
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '4px 24px 20px' }}>
          ...
          {/* Membresía */}
          <div style={{ margin: '16px 0 4px', fontSize: 11, fontWeight: 700, color: '#94a3b8', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            Membresía
          </div>
          ...
          {/* Datos personales */}
          <div style={{ margin: '20px 0 4px', fontSize: 11, fontWeight: 700, color: '#94a3b8', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            Datos Personales
          </div>
          ...
          {socio.observaciones && (
            <>
              ...
              <div style={{ fontSize: 13, color: '#475569', lineHeight: 1.6, paddingTop: 8 }}>
                {socio.observaciones}
              </div>
            </>
          )}
