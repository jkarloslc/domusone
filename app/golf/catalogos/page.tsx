...
type IngresoMap    = { id: number; id_centro_venta_fk: number; id_centro_ingreso_fk: number; activo: boolean }

const emptyCentroForm = () => ({ nombre: '', descripcion: '', orden: 1, id_centro_ingreso_fk: '' as string | number })
      ...
      <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
        {loading ? (
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
            <thead>
              <tr style={{ borderBottom: '1px solid #e2e8f0', background: '#f8fafc' }}>
                {['Nombre', 'Descripción', 'Orden', 'Centro de Ingreso', 'Estatus'].map(h => (
