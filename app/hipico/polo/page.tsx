      ...
      <div className="page-header">
        <div className="page-header-left" style={{ display: 'block' }}>
          <div className="page-eyebrow">
            <PoloIcon size={16} />
            <span className="page-eyebrow-label" style={{ color: 'var(--blue)' }}>Hípico y Eventos</span>
          </div>
          <h1 className="page-title-xl">Polo</h1>
          <p className="page-subtitle">Registro de caballos de polo y bitácora de servicios</p>
        </div>
      </div>
